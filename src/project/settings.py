...
CORS_ALLOWED_ORIGINS = os.getenv('CORS_ALLOWED_ORIGINS', COMMON_LOCALHOST_URLS)
...
ACCESS_TOKEN_LIFETIME = os.getenv('ACCESS_TOKEN_LIFETIME', default=60)
REFRESH_TOKEN_LIFETIME = os.getenv('REFRESH_TOKEN_LIFETIME', default=240)
SIMPLE_JWT = {
    'ACCESS_TOKEN_LIFETIME': timedelta(minutes=int(ACCESS_TOKEN_LIFETIME)),
    'REFRESH_TOKEN_LIFETIME': timedelta(minutes=int(REFRESH_TOKEN_LIFETIME)),
